...
namespace battle
{
...

    {
        ...
        public bool ConsumeFlask()
        {
            ...
            {
                Flask--;
                Console.WriteLine("You used a flask, you gained 50hp");
                return true;
            }
            else
            {
    ...
    public class CombatLucius
    {
        ...
        public void BattleLucius()
        {
            ...
            Enemy LordLucius = new Enemy($"Lord Lucius", 100, new int[] { 20, 25, 40 });
            basicItems items = new basicItems(new int[] { 15, 20, 35 }, "Book of Knowledge", 3);
            bool isHit = false;
        ...
        private static void Riddle()
        {
            ...
            while (CharHp.hp >0)
            {
                ...
                do
                {
                    ...
                    if (answer == "shadow")
                    {
                        Console.WriteLine("I did not expect you to get it on the first try.");
                        break;
                    }
                    else
                    {
...
Exploring the temple, you discover a chamber bathed in an otherworldly glow. At its center rests a pedestal, upon which sits an ancient artifact, pulsating with power.";
            ...
            do
            {
                ...
                if (get == "yes")
                {
                    ...
                    if (get == "yes")
                    {
                        Console.WriteLine("You used skill assess!");
...
a battle of minds is what I seek.";
            ...
            do
            {
                ...
                if (response == "yes")
                {
                    Console.WriteLine("Ygrda wasted no time and pitched you a riddle....");
                    Riddle();
                    break;
                }
                else if (response == "no")
  ...
  \  $$$$//$$__  $$| $$  | $$      | $$  | $$| $$  | $$| $$|_  $$_/  
   \  $$/| $$  \ $$| $$  | $$      | $$  | $$| $$  | $$| $$  | $$    
    ...
    |__/  \______/  \______/        \____ $$$ \______/ |__/   \___/  
            ...
            string floor2 = @"Ygdra explained that you have met the requirements to proceed to floor 2 as you have proven that you have the strength and wits to be able to 
reach higher floors";
